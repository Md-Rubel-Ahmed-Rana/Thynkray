...
export const internationalNews: NewsArticle[] = [
  {
    ...
    description:
      "World leaders have convened to discuss urgent climate change initiatives...",
  ...
  },
  {
    ...
    description:
      "Scientists have announced a promising breakthrough in cancer treatment.",
  ...
  },
  {
    ...
    author: "Jane Smith",
    title: "Apple Unveils New Mixed Reality Headset",
    description:
      "Apple's long-awaited mixed reality headset has finally been revealed.",
  ...
  },
  {
    ...
    title: "Stock Markets Rally After Interest Rate Cuts",
    description:
      "Markets around the world responded positively after major rate cuts.",
  ...
  },
  {
    ...
    title: "Sudan Crisis: Peace Talks Show Progress",
    description: "Peace talks in Sudan are showing early signs of success.",
  ...
  },
  {
    ...
    author: "Mike Ross",
    title: "OpenAI Launches GPT-5 for Public Use",
    description:
      "The latest AI model promises even more powerful natural language capabilities.",
  ...
  },
  {
    ...
    description:
      "The multinational mission has landed a new rover on Mars to explore ancient life signs.",
  ...
  },
  {
    ...
    author: "Emily Clark",
    title: "Global Protests Demand Climate Justice",
    description:
      "Millions took to the streets demanding urgent action against climate change.",
    url: "https://www.nytimes.com/2025/04/26/world/protests-climate.html",
    urlToImage:
  ...
  },
  {
    source: { id: "bbc-news", name: "BBC News" },
    author: "Tom White",
    title: "AI Takes Center Stage at Global Tech Forum",
    description:
      "The world's largest tech conference highlights AI's expanding influence.",
  ...
  },
  {
    ...
    title: "Economic Outlook 2025: Recovery on the Horizon",
    description:
      "Economists predict gradual recovery despite ongoing global challenges.",
  ...
  },
  {
    ...
    title: "Major Cities Set Ambitious Net-Zero Targets",
    description:
      "Cities pledge aggressive action plans to achieve net-zero emissions.",
  ...
  },
  {
    ...
    description: "Food insecurity worsens as global prices hit record highs.",
  ...
  },
  {
    source: { id: "reuters", name: "Reuters" },
    author: "Reuters",
    title: "Oil Prices Plunge Amid Global Surplus",
    description: "Oil markets reacted to growing inventory levels worldwide.",
  ...
  },
  {
    ...
    title: "Tech Giants Commit to Ethical AI Standards",
    description:
      "Major technology firms sign agreement to prioritize ethical AI development.",
